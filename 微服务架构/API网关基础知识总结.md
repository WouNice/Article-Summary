...
下图来源于[百亿规模 API 网关服务 Shepherd 的设计与实现](https://mp.weixin.qq.com/s/iITqdIiHi3XGKq6u6FRVdg)这篇文章。

![](./assets/img-wwtp-e.png)
...
Kong 是一款基于`OpenResty`的高性能、云原生、可扩展、生态丰富的网关系统，主要由 3 个组件组成：
...
- [2022最新Kong插件开发教程](https://cloud.tencent.com/developer/article/2104299)
