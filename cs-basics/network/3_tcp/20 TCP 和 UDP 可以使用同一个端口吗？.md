...
.168.1.100:37272     172.19.11.200:8888    TIME_WAI
```
...
```bash
客户端地址:端口           服务端地址:端口         TCP 连接状态
.168.1.100:2222      172.19.11.21:8888     TIME_WAIT
```
