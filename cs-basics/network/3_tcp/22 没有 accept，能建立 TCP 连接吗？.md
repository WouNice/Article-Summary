...
![不执行 accept 时抓包结果](./assets/不执行 accept 时抓包结果.png)
...
![每个listen Socket都有一个全连接和半连接队列](./assets/每个listen Socket都有一个全连接和半连接队列.png)
...
![半连接全连接队列的内部结构](./assets/半连接全连接队列的内部结构.png)
...
![tcp_abort_on_overflow 为 0](./assets/tcp_abort_on_overflow 为 0.png)
...
![tcp_abort_on_overflow 为 1](./assets/tcp_abort_on_overflow 为 1.png)
...
![tcp_syncookies=1](./assets/tcp_syncookies=1.png)
