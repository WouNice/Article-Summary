...
![取消序列号相对值显示](./assets/取消序列号相对值显示.jpg)
...
![TCP 三次握手和四次挥手的流程](./assets/TCP 三次握手和四次挥手的流程.jpg)
...
tcp	192.168.12.37:36008	SYN_RECV	192.168.12.36:80	0
```
...
tcp	0	0	192.168.12.37:36808	192.168.12.36:80	ESTABLISHED 8844/telnet
```
...
# 服务端执行 netstat
$ netstat -napt | grep 192.168.12.37
$ #显示空白，说明服务端刚才处于SYN_RECV状态的TCP连接不见了
```
...
# 客户端执行 netstat
$ netstat -napt | grep 192.168.12.36
tcp	   0	192.168.12.37:36008	192.168.12.36:80	ESTABLISHED 8844/telnet
```
...
![常规 HTTP 请求 与 Fast  Open HTTP 请求](./assets/常规 HTTP 请求 与 Fast Open HTTP 请求.jpg)
...
![TCP Fast Open 抓包分析](./assets/TCP Fast Open 抓包分析.jpg)
...
![理想状态下的窗口变化](./assets/理想状态下的窗口变化.jpg)
...
![服务端繁忙状态下的窗口变化](./assets/服务端繁忙状态下的窗口变化.jpg)
...
![禁用 Nagle 算法 与 启用 Nagle 算法](./assets/禁用 Nagle 算法 与 启用 Nagle 算法.jpg)
...
![TCP 延迟确认 和 Nagle 算法混合使用](./assets/TCP 延迟确认 和 Nagle 算法混合使用.jpg)
