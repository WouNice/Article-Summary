...
>
>   我说这个报文到不了而且会传回一个icmp报文通知客户端该端口不可达，感觉面试官不太满意的样子
...
![](./assets/img-wiru-w.png)

报错连接服务器失败。

同时，我也用抓包工具，抓了这个过程。

![](./assets/img-wiru-e.png)
...
bad_packet:
		...
		tcp_v4_send_reset(NULL, skb, sk_rst_convert_drop_reason(drop_reason)); // here
	}
```
...
```v
$ gcc tcp_no_listen.c -o tcp_no_listen
$ ./tcp_no_listen
Connect to myself successfully
Recv the msg: Hello, myself~
...
```v
$ netstat-napt_|greptcp_no
tcp 0 0 127.0.0.1:34567 127.0.0.1:34567 ESTABLISHED 25029/./tcp_no_list
```
