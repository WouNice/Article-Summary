...
>   Q：面试官说https的TLS四次握手校验过程中可以同时进行tcp的三次握手，但是我看您文章写的是https在tcp三次握手后，才进行tls的握
>   手过程。我现在很疑惑，他说的到底对不对
>
>   A：肯定不行啊
>
>   A：三次握手的，前两次握手是不能携带数据的
>
>   Q：他问我https建立链接的整个过程，我回答的是先进行tcp三次握手，再进行tls的四次握手
>
>   A：因为还没有建立可靠的传输
>
>   Q：他说我说的不对
